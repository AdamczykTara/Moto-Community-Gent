...
@if ($user->profile?->profile_picture)
    <img src="{{ asset('storage/' . $user->profile->profile_picture) }}" alt="Profielfoto van {{ $user->username }}" width="200">
@endif

@if ($user->profile?->moto_picture)
    <img src="{{ asset('storage/' . $user->profile->moto_picture) }}" alt="Motorfiets van {{ $user->username }}" width="200">
@endif
